    ...
    <div class="container">
        <div class="profile-details">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label>NIC:</label>
                    <input class="profile-inputs" type="text" id="name" name="name" value="123456789V" disabled required>
    ...
    <div class="change-password-container">
        ...
        <form id="changePasswordForm">
            ...
            <div class="form-group">
                ...
                <input type="password" id="newPassword" name="confirmnewPassword" required>
