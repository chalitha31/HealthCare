...
-- Dumping data for table healthcare.bloodtest: ~12 rows (approximately)
INSERT INTO `bloodtest` (`id`, `patientDetails_id`, `reportName`, `test_type`, `issued_Date`, `mlt_id`) VALUES
	...
	(11, 7, NULL, 'lipid', NULL, NULL),
	(12, 13, NULL, 'ppbs', NULL, NULL),
...
-- Dumping data for table healthcare.medicines: ~15 rows (approximately)
INSERT INTO `medicines` (`id`, `name`, `brand`, `quantity`, `exp`, `purchase_date`, `outofstock_date`) VALUES
	...
	(6, 'pirition', 'zetra pvt ltd', 460, '2024-08-28', '2024-07-03', NULL),
...
-- Dumping data for table healthcare.medicines_recode: ~10 rows (approximately)
...
-- Dumping data for table healthcare.mlt_equipments: ~8 rows (approximately)
INSERT INTO `mlt_equipments` (`id`, `name`, `quantity`, `weekly`) VALUES
	(1, 'Blood collection tubes', 35, 21),
	(2, 'Latex gloves', 135, 25),
	(3, 'Urine collection cups', 10, 27),
	(4, 'Sterile syringes', 481, 54),
	(5, 'Hypodermic needles', 18, 16),
	(6, 'EDTA tubes (lavender top)', -13, 21),
	(7, 'Sterile gauze pads', 81, 41),
	(8, 'test tube', 11, 9);
...
INSERT INTO `patients_details` (`id`, `patients_id`, `age`, `reception_id`, `symptoms`, `medical_report`, `Prescriptions`, `Prescriptions_date`, `doctor_id`, `symptoms_date`, `medicine_status`) VALUES
	...
	(10, 10, 68, '1990563467', ' Skin Rash\nRedness, itching, swelling, blisters.', 'no', 'piriton', '2024-06-29 03:06:50', '1988235678', '2024-06-28 18:15:56', 'pending'),
