...
Database::iud("UPDATE `patients_details` SET `Prescriptions` = '".$prescription."' WHERE `id` ='".$pdi."' ");
echo " prescription add successful! ";
    } elseif (!empty($medicalReport) && empty($prescription)) {

        Database::iud("UPDATE `patients_details` SET `medical_report` = '".$medicalReport."' WHERE `id` ='".$pdi."' ");
        echo "medical report  add successful! ";
      
    } elseif (!empty($medicalReport) && (!empty($prescription))) {

        Database::iud("UPDATE `patients_details` SET `Prescriptions` = '".$prescription."',`medical_report` = '".$medicalReport."' WHERE `id` ='".$pdi."' ");
